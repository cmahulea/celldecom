function newPart = refine_partition(PN)
...
%            newPart{i}.adj(adjacent_regions(k),regions_in_trajectories(j)) = 0;
%            newPart{i}.adj(regions_in_trajectories(j),adjacent_regions(k)) = 0;
%        end
%        newPart{i}.adj(regions_in_trajectories(j),regions_in_trajectories(j)) = 0;
